...
public class MysqlSchemaCodegenTest {
    ...
    public void testToCodegenMysqlDataTypeDefaultWithExceptionalColumnType() throws Exception {
        final MysqlSchemaCodegen codegen = new MysqlSchemaCodegen();
        HashMap<String, Object> defaultMap = null;
    ...
    /*
    @Test(expectedExceptions = {java.lang.RuntimeException.class})
    public void testToMysqlIdentifierWithEmptyString() throws Exception {
        final MysqlSchemaCodegen codegen = new MysqlSchemaCodegen();
